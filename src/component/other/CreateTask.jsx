    ...
    <form onSubmit={(e)=>submitHandler(e)} className="flex w-full flex-wrap items-start justify-between">
        <div  className="w-1/2 ">
            <div>
                ...
                <input value={taskTitle} onChange={(e)=>setTaskTitle(e.target.value)} className=" text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" type="text" placeholder="Member UI design" />
            </div>
            <div>
        ...
        <div  className="w-2/5 flex flex-col items-start ">
            ...
            <textarea value={taskDescription} onChange={(e)=>setTaskDescription(e.target.value)} className="text-sm py-2 h-44 px-2 w-full rounded outline-none bg-transparent border-[1px] border-gray-400" name="" id="" color="30" rows="10"></textarea>
